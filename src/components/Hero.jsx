  ...
  return (
    <section id="hero">
      ...
      <div className="hero-sub-row">
        <p className="hero-sub">Ascendry ist eine kreativ Boutique für CGI, Content und Weblösungen. Wir gestalten visuelle Systeme, die Marken sichtbar machen, Emotionen wecken und messbare Ergebnisse liefern.</p>
